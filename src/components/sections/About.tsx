    ...
    <div className="flex-1 min-h-0 flex items-center px-6 sm:px-12 xl:px-24 py-10">
      <div className="w-full flex flex-col lg:flex-row items-center gap-12">
        ...
        <motion.div
          ...
          viewport={viewport}
        >
          <motion.div variants={fadeLeft} className="max-w-5xl space-y-6">
            ...
            <p className="text-muted text-lg leading-relaxed">
              I'm a full-stack developer who enjoys solving problems and always
              striving to build solutions that make a positive impact.
            </p>
          </motion.div>
          ...
          <motion.div variants={staggerContainer} className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {aboutCards.map((card) => (
              ...
              >
                <h3 className="text-accent text-base font-bold tracking-wide uppercase">
                  {card.title}
                </h3>
